...
def run_training_process(model_name,
    ...
    filename_train_validation_set = join(temp_folder_bock, 'feature_bock_' + str(ii) + '.h5')
    filename_labels_train_validation_set = join(temp_folder_bock, 'labels_bock_' + str(ii) + '.pkl')
    filename_sample_weights = join(temp_folder_bock, 'sample_weights_bock_' + str(ii) + '.pkl')
    filename_scaler = join(temp_folder_bock, 'scaler_bock_' + str(ii) + '.pkl')
